...
VALUES
(1, 'GlobalTravel', 'Tour1', 'KR', 28, 5, '2025-08-01', '2035-08-05', 1010000, 510000, 110000, 0),
(2, 'SkyTours', 'Tour2', 'JP', 10, 5, '2025-08-02', '2035-08-06', 1020000, 510000, 110000, 0),
(3, 'GlobalTravel', 'Tour3', 'CN', 12, 5, '2025-08-03', '2035-08-07', 1030000, 510000, 110000, 0),
(4, 'AdventurePlus', 'Tour4', 'US', 11, 5, '2025-08-04', '2035-08-08', 1040000, 510000, 110000, 0),
(5, 'SkyTours', 'Tour5', 'CA', 10, 5, '2025-08-05', '2035-08-09', 1050000, 510000, 110000, 0),
(6, 'WorldExplorer', 'Tour6', 'AU', 14, 5, '2025-08-06', '2035-08-10', 1060000, 510000, 110000, 0),
(7, 'GlobalTravel', 'Tour7', 'FR', 29, 5, '2025-08-07', '2035-08-11', 1070000, 510000, 110000, 0),
(8, 'SkyTours', 'Tour8', 'DE', 23, 5, '2025-08-08', '2035-08-12', 1080000, 510000, 110000, 0),
(9, 'AdventurePlus', 'Tour9', 'IT', 34, 5, '2025-08-09', '2035-08-13', 1090000, 510000, 110000, 0),
(10, 'GlobalTravel', 'Tour10', 'ES', 14, 5, '2025-08-10', '2035-08-14', 1100000, 510000, 110000, 0),
(11, 'WorldExplorer', 'Tour11', 'GB', 25, 5, '2025-08-11', '2035-08-15', 1110000, 510000, 110000, 0),
(12, 'SkyTours', 'Tour12', 'BR', 34, 5, '2025-08-12', '2035-08-16', 1120000, 510000, 110000, 0),
(13, 'AdventurePlus', 'Tour13', 'AR', 21, 5, '2025-08-13', '2035-08-17', 1130000, 510000, 110000, 0),
(14, 'SkyTours', 'Tour14', 'MX', 33, 5, '2025-08-14', '2035-08-18', 1140000, 510000, 110000, 0),
(15, 'GlobalTravel', 'Tour15', 'IN', 17, 5, '2025-08-15', '2035-08-19', 1150000, 510000, 110000, 0),
(16, 'WorldExplorer', 'Tour16', 'RU', 39, 5, '2025-08-16', '2035-08-20', 1160000, 510000, 110000, 0),
(17, 'SkyTours', 'Tour17', 'TR', 39, 5, '2025-08-17', '2035-08-21', 1170000, 510000, 110000, 0),
(18, 'AdventurePlus', 'Tour18', 'EG', 22, 5, '2025-08-18', '2035-08-22', 1180000, 510000, 110000, 0),
(19, 'SkyTours', 'Tour19', 'ZA', 14, 5, '2025-08-19', '2035-08-23', 1190000, 510000, 110000, 0),
(20, 'GlobalTravel', 'Tour20', 'ID', 26, 5, '2025-08-20', '2035-08-24', 1200000, 510000, 110000, 0);
...
(0,4,2,'AIR','시드니','AIR activity for Tour1',NULL,'CJU','ICN',NULL),
(1,5,2,'POINT','빅토리아 항구','POINT activity for Tour1','HKG',NULL,NULL,NULL),
(2,6,2,'AIR','도쿄','AIR activity for Tour1',NULL,'GMP','CJU',NULL),
(0,7,3,'HOTEL','파리 센트럴 호텔','HOTEL activity for Tour1','PAR',NULL,NULL,2),
(1,8,3,'AIR','시카고','AIR activity for Tour1',NULL,'ICN','GMP',NULL),
...
(0,12,5,'AIR','홍콩','AIR activity for Tour2',NULL,'CJU','ICN',NULL),
...
(0,16,7,'AIR','서울','AIR activity for Tour3',NULL,'GMP','CJU',NULL),
...
(1,33,13,'AIR','서울','AIR activity for Tour6',NULL,'ICN','GMP',NULL),
...
(1,36,14,'AIR','뉴욕','AIR activity for Tour6',NULL,'CJU','ICN',NULL),
(2,37,14,'AIR','로마','AIR activity for Tour6',NULL,'GMP','CJU',NULL),
...
(0,40,16,'AIR','파리','AIR activity for Tour7',NULL,'ICN','GMP',NULL),
(1,41,16,'AIR','뉴욕','AIR activity for Tour7',NULL,'CJU','ICN',NULL),
(2,42,16,'HOTEL','베를린 시티 호텔','HOTEL activity for Tour7','BER',NULL,NULL,5),
(0,43,17,'AIR','시드니','AIR activity for Tour7',NULL,'GMP','CJU',NULL),
(1,44,17,'HOTEL','로마 시티 호텔','HOTEL activity for Tour7','ROM',NULL,NULL,3),
(0,45,18,'AIR','샌프란시스코','AIR activity for Tour7',NULL,'ICN','GMP',NULL),
...
(1,48,19,'AIR','서울','AIR activity for Tour8',NULL,'CJU','ICN',NULL),
(2,49,19,'AIR','뉴욕','AIR activity for Tour8',NULL,'GMP','CJU',NULL),
(0,50,20,'AIR','샌프란시스코','AIR activity for Tour8',NULL,'ICN','GMP',NULL),
(1,51,20,'AIR','도쿄','AIR activity for Tour8',NULL,'CJU','ICN',NULL),
...
(1,55,22,'AIR','방콕','AIR activity for Tour9',NULL,'GMP','CJU',NULL),
...
(0,59,24,'AIR','시카고','AIR activity for Tour10',NULL,'ICN','GMP',NULL),
...
(0,65,27,'AIR','로마','AIR activity for Tour11',NULL,'ICN','GMP',NULL),
...
(2,69,28,'AIR','도쿄','AIR activity for Tour11',NULL,'CJU','ICN',NULL),
...
(0,73,30,'AIR','시드니','AIR activity for Tour12',NULL,'GMP','CJU',NULL),
(1,74,30,'POINT','홍콩 빅토리아 항구','POINT activity for Tour12','HKG',NULL,NULL,NULL),
(2,75,30,'AIR','런던','AIR activity for Tour12',NULL,'ICN','GMP',NULL),
(0,76,31,'POINT','마리나 베이','POINT activity for Tour12','SIN',NULL,NULL,NULL),
(1,77,31,'AIR','런던','AIR activity for Tour12',NULL,'CJU','ICN',NULL),
...
(0,84,34,'AIR','샌프란시스코','AIR activity for Tour13',NULL,'ICN','GMP',NULL),
...
(0,95,38,'AIR','홍콩','AIR activity for Tour15',NULL,'GMP','CJU',NULL),
...
(1,100,40,'AIR','도쿄','AIR activity for Tour16',NULL,'ICN','GMP',NULL),
(0,101,41,'AIR','홍콩','AIR activity for Tour16',NULL,'CJU','ICN',NULL),
...
(1,105,42,'AIR','싱가포르','AIR activity for Tour17',NULL,'GMP','CJU',NULL),
...
(0,108,44,'AIR','시드니','AIR activity for Tour18',NULL,'ICN','GMP',NULL),
...
(0,113,46,'AIR','도쿄','AIR activity for Tour19',NULL,'CJU','ICN',NULL),
...
(1,118,48,'AIR','파리','AIR activity for Tour19',NULL,'ICN','GMP',NULL),
(2,119,48,'AIR','런던','AIR activity for Tour19',NULL,'CJU','ICN',NULL),
(0,120,49,'AIR','파리','AIR activity for Tour20',NULL,'GMP','CJU',NULL),
